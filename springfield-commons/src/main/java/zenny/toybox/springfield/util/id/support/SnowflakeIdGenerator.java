 ...
 * <p>
 * Note that for the snowflake algorithm, the key to ensure that the ID
 * generated by it is globally unique is: 1. Time; 2. Identifier and
 * sub-identifier.
 * <p>
 * Therefore, when using this algorithm, it is important to ensure that there
 * are time service servers in the server cluster, and locate the unique
 * combination of identifier and sub-identifier through
 * {@link IdentifierLookup}.
 *
 * @author Zenny Xu
