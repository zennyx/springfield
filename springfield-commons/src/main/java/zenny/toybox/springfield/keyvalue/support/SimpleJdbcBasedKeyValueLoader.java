...
public class SimpleJdbcBasedKeyValueLoader extends JdbcBasedKeyValueLoader<String, String> {
  ...
  public SimpleJdbcBasedKeyValueLoader(DataSource dataSource, String sql, String keyColumnName, String valueColumnName) {
    super(dataSource, sql, toIteratee(keyColumnName), toIteratee(valueColumnName));
  }

  public SimpleJdbcBasedKeyValueLoader(JdbcTemplate template, String sql, String keyColumnName, String valueColumnName) {
