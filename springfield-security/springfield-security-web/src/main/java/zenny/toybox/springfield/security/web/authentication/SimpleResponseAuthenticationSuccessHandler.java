...
public class SimpleResponseAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
  ...
  private final BiFunction<
          HttpServletRequest, HttpServletResponse, Function<Authentication, ResponseContent>>
      contentSupplier;

  public SimpleResponseAuthenticationSuccessHandler(String successUrl) {
    this(
        successUrl,
        new DefaultResponseStrategy(HttpStatus.OK),
        (request, response) -> {
  ...
  public SimpleResponseAuthenticationSuccessHandler(
      String successUrl,
      ResponseStrategy responseStrategy,
      BiFunction<HttpServletRequest, HttpServletResponse, Function<Authentication, ResponseContent>>
          contentSupplier) {
    Assert.isTrue(
        StringUtils.hasText(successUrl) && UrlUtils.isValidRedirectUrl(successUrl),
  ...
  public void onAuthenticationSuccess(
    ...
    this.responseStrategy.response(
        request,
        response,
