...
public class SimpleResponseSessionInformationExpiredStrategy
  ...
  public SimpleResponseSessionInformationExpiredStrategy(
      String expiredUrl,
      ResponseStrategy responseStrategy,
      Function<SessionInformationExpiredEvent, ResponseContent> contentSupplier) {
    Assert.isTrue(
        StringUtils.hasText(expiredUrl) && UrlUtils.isValidRedirectUrl(expiredUrl),
  ...
  public void onExpiredSessionDetected(SessionInformationExpiredEvent event)
    ...
    this.responseStrategy.response(
        event.getRequest(),
        event.getResponse(),
        this.contentSupplier.apply(event),
        () -> {
