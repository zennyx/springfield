...
public class PersistentTokenRepositoryAdapter implements PersistentTokenRepository {
  ...
  @Nullable private final Promise repoInitializer;

  public PersistentTokenRepositoryAdapter(
      Consumer<PersistentRememberMeToken> tokenCreator,
      Function<String, PersistentRememberMeToken> tokenRetriever,
      Consumer<PersistentRememberMeToken> tokenUpdator,
  ...
  public PersistentTokenRepositoryAdapter(
      ...
      Consumer<PersistentRememberMeToken> tokenUpdator,
      Consumer<String> tokenRemover,
      @Nullable Promise repoInitializer) {
