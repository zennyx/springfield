...
public class SimpleResponseAuthenticationFailureHandler implements AuthenticationFailureHandler {
  ...
  private final BiFunction<
          HttpServletRequest,
          HttpServletResponse,
          Function<AuthenticationException, ResponseContent>>
      contentSupplier;
  ...
  public SimpleResponseAuthenticationFailureHandler(
      String failureUrl,
      ...
      BiFunction<
          ...
          contentSupplier) {
    Assert.isTrue(
        StringUtils.hasText(failureUrl) && UrlUtils.isValidRedirectUrl(failureUrl),
