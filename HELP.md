...
* [Testcontainers Typesense Module Reference Guide](https://java.testcontainers.org/modules/testcontainers/)
...
* [SAML 2.0](https://docs.spring.io/spring-boot/4.0.6/reference/web/spring-security.html#web.security.saml2)
* [WebAuthn for Spring Security](https://docs.spring.io/spring-security/reference/servlet/authentication/passkeys.html)
* [LDAP](https://docs.spring.io/spring-boot/4.0.6/reference/data/nosql.html#data.nosql.ldap)
...
* [Cassandra](https://docs.spring.io/spring-boot/4.0.6/reference/data/nosql.html#data.nosql.cassandra)
* [Spring Data for Apache Cassandra](https://docs.spring.io/spring-boot/4.0.6/reference/data/nosql.html#data.nosql.cassandra)
* [Spring Data Reactive for Apache Cassandra](https://docs.spring.io/spring-boot/4.0.6/reference/data/nosql.html#data.nosql.cassandra)
* [Couchbase](https://docs.spring.io/spring-boot/4.0.6/reference/data/nosql.html#data.nosql.couchbase)
* [Spring Data Couchbase](https://docs.spring.io/spring-boot/4.0.6/reference/data/nosql.html#data.nosql.couchbase)
* [Spring Data Reactive Couchbase](https://docs.spring.io/spring-boot/4.0.6/reference/data/nosql.html#data.nosql.couchbase)
...
* [Hazelcast](https://docs.spring.io/spring-boot/4.0.6/reference/io/hazelcast.html)
...
* [CycloneDX SBOM support](https://docs.spring.io/spring-boot/4.0.6/reference/actuator/endpoints.html#actuator.endpoints.sbom)
...
* [Cloud Foundry](https://docs.spring.io/spring-boot/4.0.6/reference/actuator/cloud-foundry.html)
* [Datadog](https://docs.spring.io/spring-boot/4.0.6/reference/actuator/metrics.html#actuator.metrics.export.datadog)
* [Dynatrace](https://docs.spring.io/spring-boot/4.0.6/reference/actuator/metrics.html#actuator.metrics.export.dynatrace)
* [Influx](https://docs.spring.io/spring-boot/4.0.6/reference/actuator/metrics.html#actuator.metrics.export.influx)
* [Graphite](https://docs.spring.io/spring-boot/4.0.6/reference/actuator/metrics.html#actuator.metrics.export.graphite)
* [New Relic](https://docs.spring.io/spring-boot/4.0.6/reference/actuator/metrics.html#actuator.metrics.export.newrelic)
* [OTLP for metrics](https://docs.spring.io/spring-boot/4.0.6/reference/actuator/metrics.html#actuator.metrics.export.otlp)
...
* [Embedded LDAP Server](https://docs.spring.io/spring-boot/4.0.6/reference/data/nosql.html#data.nosql.ldap.embedded)
...
* [`apache/artemis:latest`](https://hub.docker.com/r/apache/artemis)
...
* [`elasticsearch:7.17.10`](https://hub.docker.com/_/elasticsearch)
...
* [`typesense/typesense:30.1`](https://hub.docker.com/r/typesense/typesense)
