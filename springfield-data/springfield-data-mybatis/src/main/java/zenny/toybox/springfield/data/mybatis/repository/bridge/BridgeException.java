...
/**
 * Abstract superclass for all exceptions thrown in the {@literal bridge} package or sub-packages.
 *
 * @author Zenny Xu
 */
...
public abstract class BridgeException extends NestedRuntimeException {
  ...
  /**
   * Create a new {@code BridgeException} with the specified message and root cause.
   *
   * @param msg the detail message
