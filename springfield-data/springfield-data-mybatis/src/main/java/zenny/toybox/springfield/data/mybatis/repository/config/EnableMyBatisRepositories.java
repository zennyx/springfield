...
/**
 * Annotation to enable MyBatis repositories. Will scan the package of the annotated configuration
...
public @interface EnableMyBatisRepositories {
  ...
  /**
   * The {@link BeanNameGenerator} class to be used for naming bridged mappers within the Spring
   * container.
   *
  ...
  /**
   * This property specifies the annotation that the scanner will search for.The scanner will
   * register all interfaces in the base package that also have he specified annotation.
   *
  ...
  Class<? extends Annotation> annotationClass() default
      Annotation.class; // TODO delete (in/exclude-filter)

  /**
   * This property specifies the parent that the scanner will search for. The scanner will register
   * all interfaces in the base package that also have the specified interface class as a parent.
   *
